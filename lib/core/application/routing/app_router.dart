...
class AppRouter {
  ...
  void go(String location, {Object? extra}) =>
      mainRouter.go(location, extra: extra);

  Future<T?> push<T extends Object?>(String location, {Object? extra}) async =>
      mainRouter.push(location, extra: extra);
  ...
  static Widget _splashPageBuilder(BuildContext context, GoRouterState state) {
    return BlocProvider<SplashBloc>.value(
      value: sl<SplashBloc>()..add(SplashCheck()),
