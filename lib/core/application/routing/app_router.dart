...
class AppRouter {
        ...
        StatefulShellRoute.indexedStack(
          ...
          branches: <StatefulShellBranch>[
            StatefulShellBranch(
              ...
              routes: <RouteBase>[
                GoRoute(path: '/${Pages.home.path}', name: Pages.home.name, builder: _homePageBuilder),
              ],
            ),
            StatefulShellBranch(
              navigatorKey: profileNavigatorKey,
              routes: <RouteBase>[
                GoRoute(path: '/${Pages.profile.path}', name: Pages.profile.name, builder: _profilePageBuilder),
              ],
            ),
          ],
        ),
  ...
  static Widget _splashPageBuilder(BuildContext context, GoRouterState state) {
    return BlocProvider<SplashBloc>.value(value: sl<SplashBloc>()..add(SplashCheck()), child: SplashPage());
  }

  static Widget _homePageBuilder(BuildContext context, GoRouterState state) {
    return BlocProvider<TimerBloc>.value(value: sl<TimerBloc>(), child: HomePage());
  }

  static Widget _profilePageBuilder(BuildContext context, GoRouterState state) {
    return BlocProvider<CounterCubit>.value(value: sl<CounterCubit>(), child: ProfilePage());
  }
}
